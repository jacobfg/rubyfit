...
// Profile Version = 16.40Release
// Tag = production-akw-16.40.00-0-gd2b01be
// Product = EXAMPLE
...
#define FIT_SPORT_BITS_5_COUNT                                                   5
...
#define FIT_MANUFACTURER_MI_PULSE                                                ((FIT_MANUFACTURER)97)
...
#define FIT_MANUFACTURER_COUNT                                                   114
...
#define FIT_GARMIN_PRODUCT_COUNT                                                 125
...
#define FIT_ANTPLUS_DEVICE_TYPE_COUNT                                            21
...
#define FIT_CAMERA_EVENT_TYPE_COUNT                                              9
...
#define FIT_SENSOR_TYPE_COMPASS                                                  ((FIT_SENSOR_TYPE)2)
...
#define FIT_DEVICE_SETTINGS_MESG_SIZE                                           15
#define FIT_DEVICE_SETTINGS_MESG_DEF_SIZE                                       17
...
typedef struct
{
   ...
   FIT_UINT32 time_offset[FIT_DEVICE_SETTINGS_MESG_TIME_OFFSET_COUNT]; // s, Offset from system time.
...
typedef struct
{
   FIT_DATE_TIME timestamp; // s, Timestamp message was output
   FIT_UINT16 timestamp_ms; // ms, Fractional part of timestamp, added to timestamp
...
{
   FIT_DATE_TIME timestamp; // s, Timestamp message was output
   FIT_UINT32 system_time[FIT_AVIATION_ATTITUDE_MESG_SYSTEM_TIME_COUNT]; // ms, System time associated with sample expressed in ms.
   FIT_UINT16 timestamp_ms; // ms, Fractional part of timestamp, added to timestamp
   FIT_SINT16 pitch[FIT_AVIATION_ATTITUDE_MESG_PITCH_COUNT]; // 10430.38 * radians, Range -PI/2 to +PI/2
   FIT_SINT16 roll[FIT_AVIATION_ATTITUDE_MESG_ROLL_COUNT]; // 10430.38 * radians, Range -PI to +PI
   FIT_SINT16 accel_lateral[FIT_AVIATION_ATTITUDE_MESG_ACCEL_LATERAL_COUNT]; // 100 * m/s^2, Range -78.4 to +78.4 (-8 Gs to 8 Gs)
   FIT_SINT16 accel_normal[FIT_AVIATION_ATTITUDE_MESG_ACCEL_NORMAL_COUNT]; // 100 * m/s^2, Range -78.4 to +78.4 (-8 Gs to 8 Gs)
   FIT_SINT16 turn_rate[FIT_AVIATION_ATTITUDE_MESG_TURN_RATE_COUNT]; // 1024 * radians/second, Range -8.727 to +8.727 (-500 degs/sec to +500 degs/sec)
   FIT_UINT16 track[FIT_AVIATION_ATTITUDE_MESG_TRACK_COUNT]; // 10430.38 * radians, Track Angle/Heading Range 0 - 2pi
   ...
   FIT_UINT8 attitude_stage_complete[FIT_AVIATION_ATTITUDE_MESG_ATTITUDE_STAGE_COMPLETE_COUNT]; // %, The percent complete of the current attitude stage.  Set to 0 for attitude stages 0, 1 and 2 and to 100 for attitude stage 3 by AHRS modules that do not support it.  Range - 100
...
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT32 event_timestamp[FIT_HR_MESG_EVENT_TIMESTAMP_COUNT]; // 1024 * s,
   FIT_UINT16 fractional_timestamp; // 32768 * s,
   FIT_UINT8 time256; // 256 * s,
   FIT_UINT8 filtered_bpm[FIT_HR_MESG_FILTERED_BPM_COUNT]; // bpm,
