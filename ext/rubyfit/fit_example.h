...
#define FIT_MANUFACTURER_COUNT                                                   161
...
typedef enum
{
   FIT_DIVE_SETTINGS_FIELD_NUM_NAME = 0,
   FIT_DIVE_SETTINGS_FIELD_NUM_HEART_RATE_SOURCE = 20
...
typedef enum
{
   FIT_SET_FIELD_NUM_WEIGHT_DISPLAY_UNIT = 9
} FIT_SET_FIELD_NUM;
...
typedef enum
{
   ...
   FIT_WORKOUT_STEP_FIELD_NUM_EXERCISE_CATEGORY = 10,
...
typedef enum
{
   FIT_EXERCISE_TITLE_FIELD_NUM_WKT_STEP_NAME = 2,
   FIT_EXERCISE_TITLE_FIELD_NUM_MESSAGE_INDEX = 254,
   FIT_EXERCISE_TITLE_FIELD_NUM_EXERCISE_CATEGORY = 0,
   FIT_EXERCISE_TITLE_FIELD_NUM_EXERCISE_NAME = 1
